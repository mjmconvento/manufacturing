...
namespace Fareast\PdfBundle\Model;
...
class PdfManager 
{
    ...
    public function newPdf($format = 'page'){
       ...
       switch ($format){
        case 'barcode':
            $this->pdf = $this->pdf_container->create('L',array(30,70), 'en', true, 'UTF-8', array(2, 2, 2, 2));
        ...
        case 'page_receipt' :
        default: $this->pdf = $this->pdf_container->create('P', 'A6', 'en', true, 'UTF-8', array(10, 15, 10, 15));
            break;
