...
class ExpiredController extends Controller
{
	...
	{
		$this->title = 'Already Expired Items';
        $params = $this->getViewParams('', 'serenitea_dashboard_expired');
        $this->csv = 'serenitea_dashboard_expired_csv';
        ...
        return $this->render('SereniteaDashboardBundle:Dashboard:expired.html.twig', $params);
	}
