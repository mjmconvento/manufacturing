...
class ConfirmedSchedulesController extends BaseController
{
    public function indexAction($date_from = null , $date_to = null)
    {
        ...
        $this->print = 'catalyst_report_confirmed_print';
        $this->csv = 'catalyst_report_confirmed_csv';
        $this->filter = 'catalyst_report_confirmed_summary_filter';

        // get params
        $params = $this->getViewParams('', 'catalyst_report_confirmed_summary');
