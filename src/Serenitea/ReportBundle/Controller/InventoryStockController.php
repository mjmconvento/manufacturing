...
class InventoryStockController extends CrudController{
    ...
    {
        $this->route_prefix = 'catalyst_report_stock';
    ...
    public function indexAction() {
        $this->title = 'Inventory Stock';
        $params = $this->getViewParams('', 'catalyst_report_stock_summary');
        $inv = $this->get('catalyst_inventory');
        
        $this->print = 'catalyst_report_stock_print';
        $this->csv = 'catalyst_report_stock_csv';
