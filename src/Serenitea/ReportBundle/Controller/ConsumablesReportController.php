...
class ConsumablesReportController extends BaseController
{
    public function indexAction($date_from = null , $date_to = null)
    {
        ...
        $this->print = 'catalyst_report_consumables_print';
        $this->csv = 'catalyst_report_consumables_csv';
        $this->filter = 'catalyst_report_consumables_summary_filter';

        // get params
        $params = $this->getViewParams('', 'catalyst_report_consumables_summary');
    ...
    protected function fetchData($date_from, $date_to)
    {
        ...
        $consumable_id = $this->get('catalyst_configuration')->get('catalyst_product_group_default');
