...
use Serenitea\ReportBundle\Model\ReportPDF;
...
class PoController extends CrudController{
    ...
    {
        $this->route_prefix = 'catalyst_report_po';
    ...
    public function indexAction() {
        $this->title = 'Purchase Order Report';
        $params = $this->getViewParams('', 'catalyst_report_po_summary');
        $inv = $this->get('catalyst_inventory');
        
        $this->print = 'catalyst_report_po_print';
        $this->csv = 'catalyst_report_po_csv';
...
//        $params['filter'] = $this->filter;
        ...
        return $this->render('CatalystReportBundle:InternalPo:index.html.twig', $params);
    }
...
//        $params['data'] = $data;
        ...
        return $this->render(
            'CatalystReportBundle:InternalPo:print.html.twig', $params);
    }
