...
namespace Catalyst\ConfigurationBundle\Model;
...
class ConfigurationManager
{
    ...
    public function set($id, $value)
    {
        ...
        $entry = $em->getRepository('CatalystConfigurationBundle:ConfigEntry')->find($id);
    ...
    public function getDisplayEntries()
    {
        ...
        $bundles = $this->container->getParameter('catalyst_configuration.bundles');
