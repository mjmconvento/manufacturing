...
abstract class CrudController extends BaseController
{
    ...
    public function callbackGrid($id)
    {
        ...
        return $engine->render(
            'CatalystTemplateBundle:Object:action.html.twig',
            $params
        );
    }
    ...
    public function indexAction()
    {
        ...
        if ($this->list_type != 'dynamic')
        {
            $twig_file = 'CatalystTemplateBundle:Object:list.static.html.twig';
            $this->listStatic($params);
        }
        else
        {
            $twig_file = 'CatalystTemplateBundle:Object:list.dynamic.html.twig';
        }
    ...
    public function printAction()
    {
        ...
        return $this->render(
            'CatalystTemplateBundle::print.html.twig', $params);
    }  
