...
use Catalyst\ManufacturingBundle\Entity\BOMTemplate;
use Catalyst\ManufacturingBundle\Entity\BOMDimension;
use Catalyst\ManufacturingBundle\Entity\BOMMaterial;
use Catalyst\ManufacturingBundle\Model\TemplateGenerator;
...
class TemplateController extends CrudController
{
    public function __construct()
    {
        ...
        $this->repo = 'CatalystManufacturingBundle:BOMTemplate';
    }
    ...
    protected function update($o, $data, $is_new = false)
    {
        ...
        $pg = $em->getRepository('CatalystInventoryBundle:ProductGroup')->find($data['prodgroup_id']);
        if ($pg == null)
